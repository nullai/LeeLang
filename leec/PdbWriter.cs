...
namespace leec
{
	public sealed class PdbWriter : IDisposable
	{
		...
		*/
		...
		public PdbWriter(string fileName)
		{
			/*
			_fileName = fileName;
		...
		private EmitContext Context => throw new Exception("@!!");//_metadataWriter.Context;
