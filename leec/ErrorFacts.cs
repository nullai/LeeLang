...
namespace leec
{
	public static partial class ErrorFacts
	{
		...
		private static readonly Lazy<Dictionary<ErrorCode, string>> s_helpLinksMap = new Lazy<Dictionary<ErrorCode, string>>(CreateHelpLinks);
		private static readonly Lazy<Dictionary<ErrorCode, string>> s_categoriesMap = new Lazy<Dictionary<ErrorCode, string>>(CreateCategoriesMap);
		public static readonly HashSet<string> NullableFlowAnalysisSafetyWarnings;
		public static readonly HashSet<string> NullableFlowAnalysisNonSafetyWarnings;

		static ErrorFacts()
		{
			NullableFlowAnalysisSafetyWarnings = new HashSet<string>();
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullReferenceAssignment));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullReferenceReceiver));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullReferenceReturn));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullReferenceArgument));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_UninitializedNonNullableField));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullabilityMismatchInAssignment));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullabilityMismatchInArgument));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullabilityMismatchInArgumentForOutput));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullabilityMismatchInReturnTypeOfTargetDelegate));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullabilityMismatchInParameterTypeOfTargetDelegate));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullAsNonNullable));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullableValueTypeMayBeNull));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullabilityMismatchInTypeParameterConstraint));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullabilityMismatchInTypeParameterReferenceTypeConstraint));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_PossibleNull));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_DefaultExpressionMayIntroduceNullT));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_NullLiteralMayIntroduceNullT));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_ConditionalAccessMayReturnNull));
			NullableFlowAnalysisSafetyWarnings.Add(getId(ErrorCode.WRN_AsOperatorMayReturnNull));

			NullableFlowAnalysisNonSafetyWarnings = new HashSet<string>();
			NullableFlowAnalysisNonSafetyWarnings.Add(getId(ErrorCode.WRN_ConvertingNullableToNonNullable));
		...
		private static Dictionary<ErrorCode, string> CreateHelpLinks()
		{
		...
		private static Dictionary<ErrorCode, string> CreateCategoriesMap()
		{
			var map = new Dictionary<ErrorCode, string>()
			{
				// { ERROR_CODE,    CATEGORY }
		...
		public static string GetMessage(MessageID code)
		{
			return code.ToString();
			//string message = ResourceManager.GetString(code.ToString());
		...
		public static string GetMessageFormat(ErrorCode code)
		{
			return code.ToString();
			//return new LocalizableResourceString(code.ToString(), ResourceManager, typeof(ErrorFacts));
		}

		public static string GetTitle(ErrorCode code)
		{
			return code.ToString();
		...
		public static bool PreventsSuccessfulDelegateConversion(Diagnostic[] diagnostics)
		{
