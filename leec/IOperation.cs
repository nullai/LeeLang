...
namespace leec
{
	public interface IOperation
	{
		...
		/// <summary>
		/// If the operation is an expression that evaluates to a constant value, <see cref="HasConstantValue"/> is true and <see cref="ConstantValue"/> is the value of the expression. Otherwise, <see cref="HasConstantValue"/> is false.
		/// </summary>
