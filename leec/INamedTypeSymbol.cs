...
namespace leec
{
	public interface INamedTypeSymbol : ITypeSymbol
	{
		...
		/// </summary>
		CustomModifier[] GetTypeArgumentCustomModifiers(int ordinal);
		...
		/// </summary>
		IMethodSymbol[] InstanceConstructors { get; }

		/// <summary>
		/// Get the static constructors for this type.
		/// </summary>
		IMethodSymbol[] StaticConstructors { get; }

		/// <summary>
		/// Get the both instance and static constructors for this type.
		/// </summary>
		IMethodSymbol[] Constructors { get; }
		...
		/// </summary>
		IFieldSymbol[] TupleElements { get; }
