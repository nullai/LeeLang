...
namespace leec
{
	...
	public interface IMethodBody
	{
		...
		/// </summary>
		ExceptionHandlerRegion[] ExceptionRegions
		{
			get;
		...
		/// </summary>
		ILocalDefinition[] LocalVariables { get; }
	...
	public interface IMethodDefinition : ITypeDefinitionMember, IMethodReference
	{
		...
		/// </summary>
		ICustomAttribute[] GetReturnValueAttributes(EmitContext context);
		...
		/// </summary>
		byte[] ReturnValueMarshallingDescriptor
		{
			get;
			// ^ requires this.ReturnValueIsMarshalledExplicitly;
		}
	...
	public interface ISignature
	{
		...
		/// The parameters forming part of this signature.
		/// </summary>
		IParameterTypeInformation[] GetParameters(EmitContext context);

		/// <summary>
		/// Returns the list of custom modifiers, if any, associated with the return type. 
		/// </summary>
		ICustomModifier[] ReturnValueCustomModifiers
		{
			get;
		}
	...
	public interface IMethodReference : ISignature, ITypeMemberReference
	{
		...
		/// </summary>
		IParameterTypeInformation[] ExtraParameters { get; }
