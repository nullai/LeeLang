...
namespace leec
{
	public abstract class OperationVisitor
	{
		...
		public virtual void VisitNoneOperation(IOperation operation)
		{
			// no-op
		}
		...
		public virtual void VisitFixed(IFixedOperation operation)
		{
		...
		// API moved public for V1
		// https://github.com/dotnet/roslyn/issues/21295
		public virtual void VisitPointerIndirectionReference(IPointerIndirectionReferenceOperation operation)
		{
			DefaultVisit(operation);
		}
		...
		public virtual void VisitPlaceholder(IPlaceholderOperation operation)
		{
			DefaultVisit(operation);
		}
		...
		public virtual void VisitNoPiaObjectCreation(INoPiaObjectCreationOperation operation)
		{
			VisitNoneOperation(operation);
		}
	...
	public abstract class OperationVisitor<TArgument, TResult>
	{
		...
		public virtual TResult VisitNoneOperation(IOperation operation, TArgument argument)
		{
			return default(TResult);
		}
		...
		// Make public after review: https://github.com/dotnet/roslyn/issues/21281
		public virtual TResult VisitFixed(IFixedOperation operation, TArgument argument)
		{
			// https://github.com/dotnet/roslyn/issues/21281
			//return DefaultVisit(operation, argument);
		...
		// API moved public for V1
		// https://github.com/dotnet/roslyn/issues/21295
		public virtual TResult VisitPointerIndirectionReference(IPointerIndirectionReferenceOperation operation, TArgument argument)
		{
			return DefaultVisit(operation, argument);
		}
		...
		// https://github.com/dotnet/roslyn/issues/21294
		public virtual TResult VisitPlaceholder(IPlaceholderOperation operation, TArgument argument)
		{
			return DefaultVisit(operation, argument);
		}
		...
		public virtual TResult VisitNoPiaObjectCreation(INoPiaObjectCreationOperation operation, TArgument argument)
		{
			return VisitNoneOperation(operation, argument);
		}
