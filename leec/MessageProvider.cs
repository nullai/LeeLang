...
namespace leec
{
	public class MessageProvider : CommonMessageProvider
	{
		...
		public override string LoadMessage(int code)
		{
			return ErrorFacts.GetMessage((ErrorCode)code);
		}
		...
		public override string GetDescription(int code)
		{
			return ErrorFacts.GetDescription((ErrorCode)code);
		}

		public override string GetTitle(int code)
		{
		...
		{
			return new LeeDiagnostic(info, Location.None);
		}
		...
		public override ReportDiagnostic GetDiagnosticReport(DiagnosticInfo diagnosticInfo, CompilationOptions options)
		{
			...
			return LeeDiagnosticFilter.GetDiagnosticReport(diagnosticInfo.Severity,
															  true,
		...
		public override void ReportParameterNotValidForType(DiagnosticBag diagnostics, GreenNode attributeSyntax, int namedArgumentIndex)
		{
		...
		public override void ReportAttributeParameterRequired(DiagnosticBag diagnostics, GreenNode attributeSyntax, string parameterName)
		{
			var node = (AttributeSyntax)attributeSyntax;
			diagnostics.Add(ErrorCode.ERR_AttributeParameterRequired1, node.Name.Location, parameterName);
		}

		public override void ReportAttributeParameterRequired(DiagnosticBag diagnostics, GreenNode attributeSyntax, string parameterName1, string parameterName2)
		{
			var node = (AttributeSyntax)attributeSyntax;
