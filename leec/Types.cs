...
namespace leec
{
	...
	{
		SystemObject = SpecialType.System_Object,
		SystemDecimal = SpecialType.System_Decimal,
		SystemTypedReference = SpecialType.System_TypedReference,
		SystemType = WellKnownType.System_Type,
		SystemInt32 = SpecialType.System_Int32,
		SystemVoid = SpecialType.System_Void,
		SystemString = SpecialType.System_String,
	}
	...
	public interface IParameterTypeInformation : IParameterListEntry
	{
		...
		/// </summary>
		ICustomModifier[] CustomModifiers
		{
			get;
		}
		...
		/// </summary>
		ICustomModifier[] RefCustomModifiers
		{
			get;
		}
	...
	public interface IGenericTypeInstanceReference : ITypeReference
	{
		...
		/// </summary>
		ITypeReference[] GetGenericArguments(EmitContext context);
	...
	public interface IModifiedTypeReference : ITypeReference
	{
		...
		/// </summary>
		ICustomModifier[] CustomModifiers { get; }
	...
	public struct TypeReferenceWithAttributes
	{
		...
		/// </summary>
		public ICustomAttribute[] Attributes { get; }

		public TypeReferenceWithAttributes(
			ITypeReference typeRef,
			ICustomAttribute[] attributes = null)
		{
			TypeRef = typeRef;
			Attributes = attributes ?? new ICustomAttribute[0];
		}
	}
	...
	public interface ITypeDefinition : IDefinition, ITypeReference
	{
		...
		/// WindowsRuntimeImportAttribute is a pseudo custom attribute defined as an public class in System.Runtime.InteropServices.WindowsRuntime namespace.
